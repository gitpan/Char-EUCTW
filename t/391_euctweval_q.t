...
if (Char::EUCTW::eval q{ Char::EUCTW::eval " if ('¢¢¡ü' !~ /¢¡/) { return 1 } else { return 0 } " }) {
...
if (Char::EUCTW::eval q{ Char::EUCTW::eval qq{ if ('¢¢¡ü' !~ /¢¡/) { return 1 } else { return 0 } } }) {
...
if (Char::EUCTW::eval q{ Char::EUCTW::eval q{ if ('¢¢¡ü' !~ /¢¡/) { return 1 } else { return 0 } } }) {
...
if (Char::EUCTW::eval q{ if ('¢¢¡ü' !~ /¢¡/) { return "1" } else { return "0" } }) {
...
if (Char::EUCTW::eval q{ if ('¢¢¡ü' !~ /¢¡/) { return qq{1} } else { return qq{0} } }) {
...
if (Char::EUCTW::eval q{ if ('¢¢¡ü' !~ /¢¡/) { return q{1} } else { return q{0} } }) {
...
my $var1 = 1;
my $var0 = 0;
if (Char::EUCTW::eval q{ if ('¢¢¡ü' !~ /¢¡/) { return $var1 } else { return $var0 } }) {
