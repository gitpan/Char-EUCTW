...
=head1 Un-Escaping \ of \N, \p, \P, and \X (EUCTW software provides)

EUCTW software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (EUCTW software provide)
